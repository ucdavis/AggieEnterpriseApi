...
public static class FinancialChartValidation
{
    public static readonly Regex GlSegmentStringPattern =
        new Regex(
            "^[0-9]{3}[0-9AB]-[0-9A-Z][0-9]{3}[0-9A-Z]-[0-9P][0-9]{5}[0-9A-F]-[0-9]{5}[0-9A-EX]-[0-9][0-9A-Z]-[0-9A-Z]{3}-[0-9A-Z]{10}-[0-9X]{5}[0-9AB]-0000-000000-000000$");

    public static readonly Regex PpmSegmentStringPattern =
        new Regex("^[A-Z0-9]{10}-[0-9A-Za-z]{6}-[0-9A-Z]{7}-[0-9A-Z]{6}(-[0-9A-Z]{7}-[0-9A-Z]{5})?$");
